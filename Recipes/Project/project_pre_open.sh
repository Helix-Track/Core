...
SCRIPT_CORE_RECIPE_PRE_OPEN="$HERE/Recipes/Project/core_pre_open.sh"

# TODO: Reconnect
#
# SCRIPT_PROPRIATERY_RECIPE_PRE_OPEN="$HERE/Propriatery/Recipes/Project/propriatery_pre_open.sh"
